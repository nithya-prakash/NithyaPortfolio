...
export default function About() {
  return (
    ...
    >
      <SectionHeading eyebrow="About" index="01" title={about.headline} />
      ...
      <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
        ...
        <Reveal delay={0.15} className="space-y-10">
          <div>
            <h3 className="text-xs uppercase tracking-[0.2em] text-ink-faint">What I work across</h3>
          ...
          <div>
            <h3 className="text-xs uppercase tracking-[0.2em] text-ink-faint">What I care about</h3>
